...
- Last scan: `2026-09-16 22:44`
- Command: `python track_production.py`
- Closed items: **12/28 (43%)**
...
Work next: **p0-bm25-delete — Delete BM25 chunks with the document**

Call BM25Store.delete_document in documents.py
